    ...
    <el-table v-loading="loading" :data="apiInfoList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="类型" align="center" prop="type">
        <template slot-scope="scope">
          <dict-tag :dict-enum="tpyeEnum" :value="scope.row.type" />
        </template>
      </el-table-column>
      <el-table-column label="状态" align="center" prop="status">
        <template slot-scope="scope">
          <dict-tag :dict-enum="statusEnum" :value="scope.row.status" />
        </template>
      </el-table-column>
      ...
      <el-table-column label="操作" align="center" width="270px">
        <template slot-scope="scope">
          ...
          <el-button size="mini" type="text" icon="el-icon-s-promotion" :disabled="!scope.row.isCanRelease" @click="releaseApi(scope.row)">发布</el-button>
          <el-button size="mini" type="text" icon="el-icon-bottom" :disabled="!scope.row.isCanOffline" @click="offlineApi(scope.row)">下线</el-button>
