<template>
  <div class="app-container">
    ...
    <el-divider />
    <el-form ref="form" inline :model="form" :rules="rules" label-width="80px" label-position="left" style="margin-left: 20px;">
      ...
      <!-- 引入SQL代码在线编辑框组件 -->
      <sql-code ref="cm" :sql="sqlContent" :handle-s-q-l="handleSQL" />

      <el-tabs v-show="showTab" v-model="activeName" style="height:300px; overflow: auto;">
    ...
    <div style="margin-top: 10px;">
      ...
      <el-button type="primary" :disabled="!isCanSmoke" @click="smokeTest">冒 烟</el-button>
      <el-button type="primary" :disabled="!isCanRelease" @click="releaseApi">发 布</el-button>
